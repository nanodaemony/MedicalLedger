...
public class End2endIdemixIT extends End2endIT {
    ...
    public void enrollIdemixUser(SampleStore sampleStore) throws Exception {
        for (SampleOrg sampleOrg : testSampleOrgs) {
            ...
            MedicalUser admin = sampleStore.getMember(TEST_ADMIN_NAME, orgName);
            MedicalUser idemixUser = sampleStore.getMember(testUser1, sampleOrg.getName());
    ...
    @Override
    Channel constructChannel(String channelName, HFClient client, SampleOrg sampleOrg) throws Exception {
