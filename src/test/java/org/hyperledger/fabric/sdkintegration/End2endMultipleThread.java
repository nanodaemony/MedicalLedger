 ...
 * @author nano
 */
public class End2endMultipleThread {
...
//    }
    ...
    public void enrollUsersSetup(SampleStore sampleStore) throws Exception {
        ...
        for (SampleOrg sampleOrg : testSampleOrgs) {
            ...
            MedicalUser user = sampleStore.getMember(TESTUSER_1_NAME, sampleOrg.getName());
            ...
            MedicalUser peerOrgAdmin = sampleStore.getMember(sampleOrgName + "Admin", sampleOrgName, sampleOrg.getMSPID(),
            ...
            sampleOrg.setAdminPeer(peerOrgAdmin); //A special user that can create channels, join peers and install chaincode
...
//        boolean doPeerEventing = !testConfig.isRunningAgainstFabric10() && FOO_CHANNEL_NAME.equals(name);
        ...
        Channel newChannel = client.newChannel(name, anOrderer, channelConfiguration, client.getChannelConfigurationSignature(channelConfiguration, sampleOrg.getAdminPeer()));
    ...
    public static void main(String[] args) throws Exception {
        ...
        final End2endMultipleThread end2endMTIT = new End2endMultipleThread();
