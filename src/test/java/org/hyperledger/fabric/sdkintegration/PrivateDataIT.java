...
public class PrivateDataIT {
    ...
    public void runFabricTest(final SampleStore sampleStore) throws Exception {
        ...
        if (testConfig.isFabricVersionAtOrAfter("1.3")) {
            ...
            CollectionConfigPackage queryCollectionsConfig = barChannel.queryCollectionsConfig(CHAIN_CODE_NAME, barChannel.getPeers().iterator().next(), sampleOrg.getAdminPeer());
    ...
    void runChannel(HFClient client, Channel channel, SampleOrg sampleOrg, final int delta) {
        ...
        try {
            ...
            channel.sendTransaction(successful, sampleOrg.getAdminPeer()).thenApply(transactionEvent -> {
                try {
