    ...
    public void setup() {
        ...
        try {
            ...
            for (SampleOrg sampleOrg : testSampleOrgs) {
                ...
                sampleOrg.setAdminPeer(sampleStore.getMember(orgName + "Admin", orgName));
            }
...
//            httppost.setEntity(new ByteArrayEntity(channelConfigurationBytes));
            ...
            final MedicalUser ordererAdmin = sampleStore.getMember(sampleOrgName + "OrderAdmin", sampleOrgName, "OrdererMSP",
            ...
            Channel.AnchorPeersConfigUpdateResult configUpdateAnchorPeers = fooChannel.getConfigUpdateAnchorPeers(fooChannel.getPeers().iterator().next(), sampleOrg.getAdminPeer(),
            ...
            fooChannel.updateChannelConfiguration(configUpdateAnchorPeers.getUpdateChannelConfiguration(),
                    client.getUpdateChannelConfigurationSignature(configUpdateAnchorPeers.getUpdateChannelConfiguration(), sampleOrg.getAdminPeer()));
            Thread.sleep(3000); // give time for events to happen
            ...
            configUpdateAnchorPeers = fooChannel.getConfigUpdateAnchorPeers(fooChannel.getPeers().iterator().next(), sampleOrg.getAdminPeer(),
                    null, null);
