 ...
 * @author nano
 */
public class MedicalConfigHelper {
     ...
     * other test suites.
     */
    public void clearCaConfig() throws NoSuchFieldException, SecurityException, IllegalArgumentException, IllegalAccessException {
